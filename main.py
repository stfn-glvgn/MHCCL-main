...
def main_worker(gpu, ngpus_per_node, args, exp_dir):
    ...
    #######
    elif args.dataset_name == 'NASDAQ':
        from config_files.NASDAQ_Configs import Config as Configs
        configs = Configs()
        train_loader, eval_loader = data_generator('data/NASDAQ', configs, 'self_supervised')
    ######
